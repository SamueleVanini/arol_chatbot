...
def get_metadata_field_info(machines_name: list[str]):
    return [
        ...
        AttributeInfo(
            name="beverage",
            description=f"A flag to indicate if the machine works in the beverage industry. The field MUST be used in lower case form. The flag is not mutual exclusive with others flags.",
            type="bool",
        ),
        AttributeInfo(
            name="food",
            description=f"Flag to indicate if the machine works in the food industry. The field MUST be used in lower case form. The flag is not mutual exclusive with others flags.",
            type="bool",
        ),
        AttributeInfo(
            name="chemical",
            description=f"Flag to indicate if the machine works in the chemical industry. The field MUST be used in lower case form. The flag is not mutual exclusive with others flags.",
            type="bool",
        ),
        AttributeInfo(
            name="pharmaceutical",
            description=f"Flag to indicate if the machine works in the pharmaceutical industry. The field MUST be used in lower case form. The flag is not mutual exclusive with others flags.",
            type="bool",
        ),
        AttributeInfo(
            name="spirits",
            description=f"Flag to indicate if the machine works in the spirits industry. The field MUST be used in lower case form. The flag is not mutual exclusive with others flags.",
            type="bool",
        ),
        AttributeInfo(
            name="personal care",
            description=f"Flag to indicate if the machine works in the personal care industry. The field MUST be used in lower case form. The flag is not mutual exclusive with others flags.",
            type="bool",
        ),
        AttributeInfo(
            name="home care",
            description=f"Flag to indicate if the machine works in the home care industry. The field MUST be used in lower case form. The flag is not mutual exclusive with others flags.",
            type="bool",
        ),
        AttributeInfo(
            name="wine",
            description=f"Flag to indicate if the machine works in the wine industry. The field MUST be used in lower case form. The flag is not mutual exclusive with others flags.",
            type="bool",
        ),
        AttributeInfo(
            name="beer",
            description=f"Flag to indicate if the machine works in the beer industry. The field MUST be used in lower case form. The flag is not mutual exclusive with others flags.",
            type="bool",
        ),
        AttributeInfo(
            name="champagne",
            description=f"Flag to indicate if the machine works in the champagne industry. The field MUST be used in lower case form. The flag is not mutual exclusive with others flags.",
            type="bool",
        ),
        AttributeInfo(
            name="champagne",
        ...
        AttributeInfo(
            name="houseold care",
            description=f"Flag to indicate if the machine works in the houseold care industry. The field MUST be used in lower case form. The flag is not mutual exclusive with others flags.",
            type="bool",
        ),
        # AttributeInfo(
        #     name="markets",
